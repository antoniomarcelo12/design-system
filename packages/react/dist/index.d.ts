...
import { ComponentProps, ElementType, Dispatch, SetStateAction } from 'react';
...
declare function Toast({ open, title, setOpen, description, variant, ...props }: ToastProps): react_jsx_runtime.JSX.Element;
...
declare function TooltipComponent({ text }: TooltipComponentProps): react_jsx_runtime.JSX.Element;
...
declare const theme: string & {
    ...
    colors: {
        ...
        newColor: _stitches_react_types_theme.Token<"newColor", string, "colors", "">;
    };
    fontSizes: {
...
declare const createTheme: <Argument0 extends string | ({
    colors?: {
        ...
        newColor?: string | number | boolean | undefined;
    } | undefined;
    fontSizes?: {
